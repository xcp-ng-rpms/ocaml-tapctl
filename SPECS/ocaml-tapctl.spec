...
%changelog
* Wed May 05 2021 Benjamin Reis <benjamin.reis@vates.fr> - 1.5.0-3.1.0.ipv6.2
- Rebuild for IPv6: for vhd-tool and xapi build

* Mon Feb 01 2021 Benjamin Reis <benjamin.reis@vates.fr> - 1.5.0-3.1.0.ipv6.1
- Rebuild for IPv6: for vhd-tool and xapi build
